...
<% } %>
  ...
  <div>
                        <form action="profiledp" method="post" id="f1">
                            <table style="text-align: center ; color: black">
                     
                                 
                           <tr><td>Education :</td> <td>  <input type="text" placeholder="Education" name="Education" id="Education" height="20px"></td></tr>
                           <tr><td>Mobile :</td> <td>  <input type="text" placeholder="mobilenumber" id="Phone_number" name="Phone_number"></td></tr>
                           <tr><td>Password:</td> <td>  <input type="password" placeholder="Password" id="Password" name="Password"></td></tr>
                           <tr><td></td>
