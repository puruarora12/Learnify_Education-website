...
<div class="wrapper row0">
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul>
        <li><a href="welcomestudent.jsp"><i class="fa fa-lg fa-home"> <%="   "+(String)session.getAttribute("email") %></i></a></li>
...
<div class="wrapper bgded overlay" style="background-image:url('dp/bgimage.jpg');"  >
  <article id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h3 class="heading">Welcome to Learnify</h3>
    <p>Let's Learn Togheter</p>
    <footer><a class="btn" href="aboutus.jsp">About us</a></footer>
    <!-- ################################################################################################ --> 
  </article>
</div>
<!-- ################################################################################################ --> 
    ...
    <ul class="nospace group">
      <li class="one_third first">
        <article><i class="btmspace-30 fa fa-3x fa-american-sign-language-interpreting"></i>
          ...
          <footer><a class="btn" href="faculty.jsp">Check More &rsaquo;</a></footer>
        </article>
      </li>
      <li class="one_third">
        <article><i class="btmspace-30 fa fa-3x fa-expeditedssl"></i>
          ...
          <footer><a class="btn" href="askquestion.jsp">ASK!! &rsaquo;</a></footer>
        </article>
      </li>
      <li class="one_third">
        <article><i class="btmspace-30 fa fa-3x fa-resistance"></i>
          <h6 class="heading font-x1">Our Idea of Change</h6>
          <p class="btmspace-30">Wish to know why we created this website in the first place ? Click the button to know  </p>
          <footer><a class="btn" href="aboutus.jsp">Read More &rsaquo;</a></footer>
        </article>
      </li>
    </ul>
    <!-- ################################################################################################ --> 
