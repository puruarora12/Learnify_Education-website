 ...
 * @author Puru
 */
@WebServlet(urlPatterns = {"/profiledp"})
public class profiledp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
        ...
        String s = (String)ss.getAttribute("Email_id");
        out.println(s);
     ...
     String qry = "update student set Password = '"+password+"' , Phone_number ='"+mobile+"' , Education= '"+education+"'"
             + " where Email_id ='"+s+"'" ;
      out.println(qry);
